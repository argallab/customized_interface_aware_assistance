...
CARTESIAN_MODE_SET_OPTIONS = { 	CartesianRobotType.R2: {ModeSetType.OneD: {1:1, 2:2}, 		ModeSetType.TwoD: {1:12}},
								CartesianRobotType.SE2_NH: {ModeSetType.OneD: {1:1, 2:2}, 		ModeSetType.TwoD: {1:12}},
								CartesianRobotType.R3: {ModeSetType.OneD: {1:1, 2:2, 3:3}, ModeSetType.TwoD: {1:12, 2:23, 3:13}, ModeSetType.ThreeD: {1:123}},
								CartesianRobotType.SE2: {ModeSetType.OneD: {1:1, 2:2, 3:3}, ModeSetType.TwoD: {1:12, 2:3}, ModeSetType.ThreeD: {1:123}},
								CartesianRobotType.SE3: {}}

CARTESIAN_DIM_NAMES = { CartesianRobotType.R2: ['X', 'Y'],
...
CARTESIAN_DIM_LABELS = { 	CartesianRobotType.R2:  {'X':'L/R', 'Y':'F/B'},
...
CARTESIAN_DIM_TO_CTRL_INDEX_MAP = { CartesianRobotType.R2: {'X':0, 'Y':1},
...
CARTESIAN_DIM_INDICATOR_TYPES = { CartesianRobotType.R2: {'X':ControlIndicatorType.Bar, 'Y':ControlIndicatorType.Bar},
								  CartesianRobotType.SE2_NH: {'V':ControlIndicatorType.Bar, 'W':ControlIndicatorType.Circle},
								  CartesianRobotType.R3: {'X':ControlIndicatorType.Bar, 'Y':ControlIndicatorType.Bar, 'Z':ControlIndicatorType.Bar},
								  CartesianRobotType.SE2: {'X':ControlIndicatorType.Bar, 'Y':ControlIndicatorType.Bar, 'YAW':ControlIndicatorType.Circle},
								  CartesianRobotType.SE3: {'X':ControlIndicatorType.Bar, 'Y':ControlIndicatorType.Bar, 'Z':ControlIndicatorType.Bar, 'ROLL':ControlIndicatorType.Circle, 'PITCH':ControlIndicatorType.Circle, 'YAW':ControlIndicatorType.Circle}}

#the following can be efficienctly created using loops
JOINT_DIM_NAMES = { JointRobotType.J1: ['J1'], 
...
JOINT_DIM_TO_CTRL_INDEX_MAP = {JointRobotType.J1:  {'J1':0}, 
...
JOINT_DIM_INDICATOR_TYPES = { 	JointRobotType.J1: {'J1': ControlIndicatorType.Circle}, 
								JointRobotType.J2: {'J1': ControlIndicatorType.Circle, 'J2': ControlIndicatorType.Circle},
								JointRobotType.J3: {'J1': ControlIndicatorType.Circle, 'J2': ControlIndicatorType.Circle, 'J3':ControlIndicatorType.Circle},
								JointRobotType.J4: {'J1': ControlIndicatorType.Circle, 'J2': ControlIndicatorType.Circle, 'J3':ControlIndicatorType.Circle, 'J4':ControlIndicatorType.Circle},
								JointRobotType.J5: {'J1': ControlIndicatorType.Circle, 'J2': ControlIndicatorType.Circle, 'J3':ControlIndicatorType.Circle, 'J4':ControlIndicatorType.Circle, 'J5':ControlIndicatorType.Circle},
								JointRobotType.J6: {'J1': ControlIndicatorType.Circle, 'J2': ControlIndicatorType.Circle, 'J3':ControlIndicatorType.Circle, 'J4':ControlIndicatorType.Circle, 'J5':ControlIndicatorType.Circle, 'J6':ControlIndicatorType.Circle},
								JointRobotType.J7: {'J1': ControlIndicatorType.Circle, 'J2': ControlIndicatorType.Circle, 'J3':ControlIndicatorType.Circle, 'J4':ControlIndicatorType.Circle, 'J5':ControlIndicatorType.Circle, 'J6':ControlIndicatorType.Circle, 'J7':ControlIndicatorType.Circle}}
