...
P_UM_GIVEN_A_MODE_DISPLAY_CIRCLE_START_POSITION_S = [VIEWPORT_WS/2 - MODE_DISPLAY_CIRCLE_X_OFFSET_S, VIEWPORT_HS/2]


MODE_DISPLAY_TEXT_START_POSITION = [(3*VIEWPORT_W)/4+ROBOT_RADIUS, VIEWPORT_H - 3.5*ROBOT_RADIUS]
P_UM_GIVEN_A_MODE_DISPLAY_TEXT_START_POSITION = [VIEWPORT_W/2 - MODE_DISPLAY_CIRCLE_X_OFFSET_S*SCALE, VIEWPORT_H/2 - 3*ROBOT_RADIUS]
